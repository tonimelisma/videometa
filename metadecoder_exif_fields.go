// Code generated by go generate ./gen; DO NOT EDIT.

package videometa

// exifFields maps EXIF tag IDs to their names.
// Names are generated from exif_fields_reference.json and match the committed exiftool 13.50 reference set.
